...
$string['error:mfarequired'] = 'Multi-factor authentication is required for the mobile app.';
...
$string['settings:enabledformobile'] = 'Require MFA in mobile app';
$string['settings:enabledformobile_help'] = 'Users will need to complete MFA in a web browser to log in to the app.';
