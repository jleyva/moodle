...
$functions = array(
    ...
    'mod_feedback_get_access_information' => array(
        'classname'     => 'mod_feedback_external',
    ...
    'mod_feedback_get_current_completed_tmp' => array(
        ...
        'description'   => 'Returns the temporary completion record for the current user or guest session.',
        'type'          => 'read',
        'capabilities'  => 'mod/feedback:view',
        'services'      => array(MOODLE_OFFICIAL_MOBILE_SERVICE)
    ),
    ...
    'mod_feedback_get_page_contents' => array(
        'classname'     => 'mod_feedback_external',
        'methodname'    => 'get_page_contents',
        'description'   => 'Get a single feedback page content including questions rendered.',
        'type'          => 'read',
        'capabilities'  => 'mod/feedback:complete',
        'services'      => array(MOODLE_OFFICIAL_MOBILE_SERVICE)
    ),
    ...
    'mod_feedback_get_responses' => array(
        'classname'     => 'mod_feedback_external',
        'methodname'    => 'get_responses',
        'description'   => 'Return the feedback user responses.',
        'type'          => 'read',
        'capabilities'  => 'mod/feedback:viewreports',
        'services'      => array(MOODLE_OFFICIAL_MOBILE_SERVICE)
    ),
