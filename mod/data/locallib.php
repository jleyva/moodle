 ...
 *
 * @param  stdClass $resource   data object
 ...
 * @param  boolean $canmanageentries  optinal, if the user can manage entries
...
/**
 * Return the number of entires left to add to complete the activity.
 *
 ...
 * @since  Moodle 3.3
 */
function data_build_search_array($data, $paging, $searcharray, $defaults = null) {
    global $DB;
