...
abstract class externallib_advanced_testcase extends \externallib_advanced_testcase {
     ...
     */
    protected function create_submission_for_testing_status($submitforgrading = false, array $params = []) {
        global $DB;
     ...
     */
    protected function create_assign_with_student_and_teacher($params = array()) {
        global $DB;
