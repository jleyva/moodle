...
class externallib_test extends \mod_assign\externallib_advanced_testcase {
    ...
    public function test_get_assignments_when_submissionattachments_is_enabled() {
        ...
        // Now set submissionattachments to enabled. We have no open submissions so assume intro attachments should not be sent.
        $DB->set_field('assign', 'submissionattachments', '1');
