...
";
     ...
     * @covers \assign::should_provide_intro_attachments
     */
    public function test_should_provide_intro_attachments_with_submissionattachments_enabled_and_no_open_submission() {
        global $DB;
        $this->resetAfterTest();
        list($assign, $instance, $student) = $this->create_submission([
            'timelimit' => '300',
     ...
     *
     * @covers \assign::is_submission_open
     */
    public function test_is_submission_open_with_open_submission() {
        global $DB;
        $this->resetAfterTest();
        set_config('enabletimelimit', '1', 'assign');
        list($assign, $instance, $student) = $this->create_submission([
        ...
        $this->assertTrue($assign->is_submission_open());
    }
     ...
     * @covers \assign::is_submission_open
     */
    public function test_is_submission_open_with_no_open_submission() {
        global $DB;
        $this->resetAfterTest();
        set_config('enabletimelimit', '1', 'assign');
        list($assign, $instance, $student) = $this->create_submission([
        ...
        // Clear all current submissions.
        $DB->delete_records('assign_submission', ['assignment' => $instance->id]);
        $this->assertFalse($assign->is_submission_open());
    }
